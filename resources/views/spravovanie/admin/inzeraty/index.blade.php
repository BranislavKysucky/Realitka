    ...
    <div class="content table-responsive table-full-width">
        <table class="table table-hover table-striped">
            ...
            <tbody id="bodyTable2">
                ...
                <tr>
                    ...
                    <td>
                        <button id="myBtn" value="{{$inzerat->id}}" style="border: none" class="btn btn-info" data-toggle="modal" data-target="#deleteInzerat" data-id="{{$inzerat -> id}}" data-pouzivatel_id="{{$pouzivatel->id}}"><i class="pe-7s-trash"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#deleteInzerat").on("show.bs.modal", function (e) {
                    var ID = $(e.relatedTarget).data('id');

                    $("#delFormInzerat").attr('action', '/inzeraty_a/' + ID);
                });
            });
        </script>
@endsection