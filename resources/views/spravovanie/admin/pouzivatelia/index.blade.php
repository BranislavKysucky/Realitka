    ...
    <div class="content table-responsive table-full-width">
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                    <button id="myBtn" value="{{$pouzivatel->id}}" style="border: none" class="btn btn-info" data-toggle="modal" data-target="#delete" data-id="{{$pouzivatel -> id}}"><i class="pe-7s-trash"></i></button>
                </td>
            </tr>
            @endforeach
            </tbody>
